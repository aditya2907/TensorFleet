...
const (
	...
	WorkerService_GetWorkerStatus_FullMethodName = "/worker.WorkerService/GetWorkerStatus"
...
func (c *workerServiceClient) ExecuteTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkerService_ExecuteTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workerServiceClient) GetWorkerStatus(ctx context.Context, in *WorkerStatusRequest, opts ...grpc.CallOption) (*WorkerStatusResponse, error) {
	out := new(WorkerStatusResponse)
	err := c.cc.Invoke(ctx, WorkerService_GetWorkerStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workerServiceClient) CancelTask(ctx context.Context, in *CancelTaskRequest, opts ...grpc.CallOption) (*CancelTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkerService_CancelTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWorkerServiceServer) GetWorkerStatus(context.Context, *WorkerStatusRequest) (*WorkerStatusResponse, error) {
...
func _WorkerService_GetWorkerStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServiceServer).GetWorkerStatus(ctx, req.(*WorkerStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
